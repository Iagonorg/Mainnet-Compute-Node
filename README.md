...
```bash
curl -L -o iag-compute-cli https://github.com/Iagonorg/Mainnet-Compute-Node/releases/download/0.1.0-beta/iag-compute-cli && chmod +x iag-compute-cli && sudo ./iag-compute-cli
```
